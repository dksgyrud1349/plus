...
public class LoginFailureHandler implements AuthenticationFailureHandler {
	...
	private String defualtFailureUrl;
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
		...
		request.getRequestDispatcher(defualtFailureUrl).forward(request, response);
		
	}

	public void setDefualtFailureUrl(String defualtFailureUrl) {
		this.defualtFailureUrl = defualtFailureUrl;
	}
