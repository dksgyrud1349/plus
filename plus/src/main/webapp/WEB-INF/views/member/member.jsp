            ...
            <div class="input-form-backgroud row">
                <div class="input-form col-md-12 mx-auto">
                    ...
                    <div class="alert alert-info" role="alert">
                        <i class="bi bi-person-check-fill"></i> 태희형의 회원이 되시면 회원님만의 유익한 정보를 만날수 있습니다.
                    </div>
                    ...
                    <div class="body-main">
                        ...
                        <form name="memberForm" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="userPwd" id="userPwd" class="form-control" autocomplete="off" placeholder="패스워드는 5~10자이며 하나 이상의 숫자나 특수문자가 포함되어야 합니다.">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" name="birth" id="birth" class="form-control"  placeholder="생년월일">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8" style="padding-top: 5px;">
                                    ...
                                    <label class="form-check-label">
                                        <a href="#" class="text-decoration-none" style="color: red;">개인정보 수집 및 이용</a>에 동의합니다.
                                    </label>
                                </div>
                            </div>
