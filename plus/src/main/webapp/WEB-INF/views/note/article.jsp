...
function deleteNote() {
	let query = "nums=${dto.noteNum}&${query}";
				...
				<div class="tab-pane fade show active mt-3" id="nav-content" role="tabpanel" aria-labelledby="nav-tab-content">
					...
					<table class="table mb-0">
						...
						<tr>
							...
							<td align="right">
								읽은날짜 : ${empty dto.identifyDate ? "읽지 않음": dto.identifyDate}
							</td>
						</tr>
						...
						<tr>
							<td colspan="2" class="ellipsis">
								...
								<c:if test="${not empty prevDto}">
									<span><a href="${pageContext.request.contextPath}/note/${menuItem}/article?${query}&noteNum=${prevDto.noteNum}">${prevDto.content}</a></span>
								</c:if>
							</td>
						</tr>
						<tr>
							<td colspan="2" class="ellipsis">
								...
								<c:if test="${not empty nextDto}">
									<span><a href="${pageContext.request.contextPath}/note/${menuItem}/article?${query}&noteNum=${nextDto.noteNum}">${nextDto.content}</a></span>
								</c:if>
							</td>
						</tr>
					</table>
