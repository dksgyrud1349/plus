					...
					<div class="table table-hover board-list " id="nav-tabContent">
						...
						<table class="table table-borderless mb-2">
							<tr>
								...
								<td class="text-end">
									<button type="button" class="btn rere" style="background: #32B0E4; color: white;" onclick="location.href='${pageContext.request.contextPath}/admin/lessonManage/list0?${query}';">리스트</button>
								</td>
							</tr>
						</table>
					</div>
