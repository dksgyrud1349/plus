...
<c:url var="listUrl" value="/admin/lessonManage/list0">
			...
			<div class="body-container" style="width: 100%; margin: 10% auto;">
				<div class="body-main">
					...
					<h3 class="mb-3 p-2" style="border-bottom:2px solid gray;">
						승인대기 클래스 관리
						<button type="button" class="btn rere" onclick="location.href='${pageContext.request.contextPath}/admin/lessonManage/list0';" title="새로고침" style="float: right; background: #32B0E4; color: white;">
								...
								<tbody>
									<c:forEach var="dto" items="${list}" varStatus="status">
										<tr style="text-align: center">
											...
											<td class="left">
												<c:url var="url" value="/admin/lessonManage/article0">
