...
<script type="text/javascript">
	function updateState(approvalCode){
		...
		if(confirm(s)){
			...
			let url = "${pageContext.request.contextPath}/admin/lessonManage/update1?" + query;
			location.href = url;
		}
	}
</script>
						...
						<table class="table table-borderless mb-2">
							<tr>
								<td width="50%">
									...
									<button type="button" class="btn btn-outline-success" onclick="updateState(1)">승인<i class="bi bi-x-lg"></i></button>
								...
								<td class="text-end">
									<button type="button" class="btn btn-success" onclick="location.href='${pageContext.request.contextPath}/admin/lessonManage/list1?${query}';">리스트</button>
								</td>
							</tr>
						</table>
					</div>
