...
<c:url var="listUrl" value="/admin/lessonManage/list2">
			...
			<div class="body-container" style="width: 80%; margin: 5% auto;">
				<div class="body-main">
					...
					<h3 class="mb-3 p-2" style="border-bottom:3px solid #cccccc;">
						<i class="bi bi-hourglass-split"></i> 승인보류 클래스 관리
						<button type="button" class="btn btn-success rere" onclick="location.href='${pageContext.request.contextPath}/admin/lessonManage/list2';" title="새로고침" style="float: right;">
					...
					<div id="tab-content" style="padding: 15px 0px 5px; clear: both;">
						...
						<div class="card mb-5 w-80 " style="margin: 0 auto">
								...
								<tbody>
									<c:forEach var="dto" items="${list}" varStatus="status">
										<tr style="text-align: center">
											...
											<td class="left">
												<c:url var="url" value="/admin/lessonManage/article2">
							...
							<table class="table">
								<tr>
									<td align="center">
										<form class="row" name="searchForm" action="${pageContext.request.contextPath}/admin/lessonManage/list2" method="post" style="width: 300px; margin-left: 100px">
