			...
			<div class="body-container" style="width: 100%; margin: 10% auto;">
				<div class="body-main">
					...
					<h3 class="mb-3 p-2" style="border-bottom:2px solid gray;">
						승인보류 클래스 관리
						<button type="button" class="btn rere" onclick="location.href='${pageContext.request.contextPath}/admin/lessonManage/list2';" title="새로고침" style="float: right; background: #32B0E4; color: white;">
