...
<c:url var="listUrl" value="/admin/lessonManage/list1">
			...
			<div class="body-container" style="width: 80%; margin: 5% auto;">
				<div class="body-main">
					...
					<h3 class="mb-3 p-2" style="border-bottom:3px solid black;">
						<i class="bi bi-app"></i> 승인완료 클래스 관리
						<button type="button" class="btn btn-success" onclick="location.href='${pageContext.request.contextPath}/admin/lessonManage/list1';" title="새로고침" style="float: right;">
					...
					<div id="tab-content" style="padding: 15px 10px 5px; clear: both;">
						...
						<div class="card mb-5 w-80 " style="margin: 0 auto">
								...
								<tbody>
									<c:forEach var="dto" items="${list}" varStatus="status">
										<tr style="text-align: center">
											...
											<td class="left">
												<c:url var="url" value="/admin/lessonManage/article1">
							...
							<table class="table">
								<tr>
									<td align="center">
										<form class="row" name="searchForm" action="${pageContext.request.contextPath}/admin/lessonManage/list1" method="post" style="width: 300px; margin-left: 100px">
