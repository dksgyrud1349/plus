...
<table class="table td-border mx-auto my-10" style="width: 99%; text-align:left;">
	<tr>
		...
		<td width="35%" class="ps-5">${dto.userId}</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="text-center bg-light">플러스 승인</td>
		<td class="ps-5">${dto.membership==51?"승인":"미승인"}</td>
	</tr>
</table>
...
<form id="deteailedMemberForm" name="deteailedMemberForm" method="post">
	...
	<table class="table td-border mx-auto mb-5">
		<tr>
