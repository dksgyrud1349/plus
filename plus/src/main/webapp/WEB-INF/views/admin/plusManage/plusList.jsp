		 	...
		 	<div class="container-fluid px-5">
				<div class="body-container" style="width:80%; margin:5% auto; ">
    				...
    				<h3 class="mb-3 p-2" style="border-bottom:3px solid black;">
	                    ...
	                    <button type="button" class="btn btn-success rere" onclick="location.href='${pageContext.request.contextPath}/admin/plusManage/plusList';" style="float:right;">
												...
												<td align="center">
													<form name="searchForm" action="${pageContext.request.contextPath}/admin/plusManage/plusList" method="post" style="width:300px;">
														<div class="input-group mb-3">
															...
															<button type="button" class="btn btn-outline-success rere" onclick="searchList()">검색</button>
														</div>
													</form>
												</td>
											</tr>
