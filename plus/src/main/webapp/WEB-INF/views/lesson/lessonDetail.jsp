							...
							<div class="fs-5 mb-5">
								...
								<span><fmt:formatNumber value="${dto.price}"
									...
									<div>
										...
										<button type="button" class="btn singo" style="width: 60x;" onclick="location.href='${pageContext.request.contextPath}/classInq/insertInq?classNum=${dto.classNum}&className=${dto.className}';">
