				...
				<div class="body-main">
					...
					<div class="tabs">
					  <ul>
						...
						<li class="active"><a href="${pageContext.request.contextPath}/suggest/article">제안하기</a></li>
					...
					<form name="suggestForm" method="post" style="margin-left:200px; margin-top:30px;">
							...
							<div style="float: right;">
								<button type="button" class="bDelaration" id="btnOk" name="btnOk" class="bSuggest"
									onclick="writeSubmit();" style="padding-top: 3px; font-size:16px;">제안하기<i class="bi bi-lightbulb-fill"></i></button>
							</div>
						</form>
					</div>
				</div>
