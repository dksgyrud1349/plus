...
<script type="text/javascript">
    function check() {
    	...
    	f.action="${pageContext.request.contextPath}/suggest/${mode}";
    	f.submit;
				...
				<div id="tab-content" style="padding: 15px 10px 5px; clear: both;">
						...
						<div class="card mb-5 w-80" style="margin:0 auto">
				        	<div class="card-header text-center">
				            	<h3>
				                	<i class="fas fa-clipboard-list"></i> 문의 등록
					            </h3>
					        </div>
								...
								<form name="SuggestForm" method="post" enctype="multipart/form-data">
									<table class="table table-border border-top2 table-form">
										...
										<tr> 
											...
											<td valign="top"> 
												<textarea name="rcontent" id="ir1" class="form-control" style="max-width: 97%; height: 290px;">${dto.content}</textarea>
											</td>
										</tr>
									...
									<table class="table">
										<tr> 
											<td align="center">
												...
												<button type="button" class="btn btn-success" onclick="location.href='${pageContext.request.contextPath}/suggest/list';">
													${mode=='update'?'수정취소':'등록취소'}
												</button>
												<c:if test="${mode=='update'}">
													<input type="hidden" name="sugNum" value="${dto.sugNum}">
