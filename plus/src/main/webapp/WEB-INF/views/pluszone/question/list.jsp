			...
			<div class="col-8">
				...
				<form class="questionForm">
					...
					<div class="col-12 mx-2 text-end">
						<button class="btn btn-outline-success"><span class="fw-semibold text-dark">등록하기 <i class="bi bi-check-lg"></i></span></button>
						<button class="btn btn-outline-danger"><span class="fw-semibold text-dark">취소하기 <i class="bi bi-x-lg"></i></span></button>
					</div>
				</form>
			</div>
		</div>
