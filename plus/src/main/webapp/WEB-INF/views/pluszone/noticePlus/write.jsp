...
<script type="text/javascript">
    function check() {
    	...
    	f.action="${pageContext.request.contextPath}/pluszone/noticePlus/${mode}";
									...
									<table class="table">
										<tr> 
											<td align="center">
												...
												<button type="button" class="btn btn-success rere" onclick="location.href='${pageContext.request.contextPath}/pluszone/noticePlus/list';">
