...
function sendLogin() {
    ...
    f.action = "${pageContext.request.contextPath}/pluszone/member/login";
    f.submit();
}
</script>
<style>
            ...
            <div class="col-md-6 offset-md-3">
                <div class="border mt-5 p-4">
                    <form name="loginForm" action="" method="post" class="row g-3">
                        ...
                        <h3 class="text-center" style="margin-top:8px; font-weight:bold;"><i class="bi bi-calendar2-plus"></i>&nbsp;플러스존</h3>
                        	<div class="col-12">
                    ...
                    <div class="col-12">
                        <p class="text-center mb-0">
                        	<a href="${pageContext.request.contextPath}/pluszone/member/idFind" class="text-decoration-none me-3">아이디 찾기</a>&nbsp;
                        	<span class="border-end border-Secondary"></span>
                        	<a href="${pageContext.request.contextPath}/pluszone/member/pwdFind" class="text-decoration-none ms-4 me-2">패스워드 찾기</a>
                        </p>
                    </div>
                </div>
