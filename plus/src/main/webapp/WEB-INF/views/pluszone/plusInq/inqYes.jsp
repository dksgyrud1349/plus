...
<script type="text/javascript">
	$(function() {
		...
		$("ul.tabs li").click(function() {
			...
			let url = "${pageContext.request.contextPath}/pluszone/plusInq/inqList";
			location.href = url;
		});
	});
			...
			<div class="body-container" style="width: 100%; margin: 5% auto;">
				<div class="body-main">
					...
					<h3 class="mb-3 p-2" style="border-bottom: 3px solid #cccccc;">
						<i class="bi bi-question-circle-fill"></i> 클래스 문의 내역
					...
					<div>
						<ul class="tabs">
							<li id="tab-0" data-tab="0"><i class="fa-solid fa-person"></i>&nbsp;문의 답변완료</li>
							<li id="tab-1" data-tab="1"><i
								class="fa-solid fa-chart-column"></i>&nbsp;문의 답변대기</li>
						</ul>
					</div>
									...
									<form name="searchForm" action="${pageContext.request.contextPath}/pluszone/plusInq/inqOkList" style="width:300px; margin-left:100px">
										<div class="input-group mb-1">
											<select name="schType" class="form-select">
												...
												<option value="inquiryDate" ${schType=="inquiryDate"?"selected":""}>문의일자</option>
										...
										<tbody>
											<c:forEach var="dto" items="${list}" varStatus="status">
												<tr class="hover">
													...
													<td class="left">
														<a href="${pageContext.request.contextPath}/pluszone/plusInq/article2?inquiryNum=${dto.inquiryNum}">${dto.subject}</a>
													</td>
